...
class Festival(db.Model):
    ...
    user_festival = db.relationship('User_Festival', cascade="all, delete", back_populates='festival')
...
class Artist(db.Model):
    ...
    song_artists = db.relationship('Song_Artist', cascade="all, delete-orphan", back_populates='artist')
    #  Define many to many relationship with User through Favorite table
    favorites = db.relationship('Favorite', cascade="all, delete", back_populates='artist')
...
class Song(db.Model):
    ...
    song_artists = db.relationship('Song_Artist', cascade="all, delete", back_populates='song')
...
class User(db.Model):
    ...
    user_festivals = db.relationship('User_Festival', cascade="all, delete", back_populates='user')
